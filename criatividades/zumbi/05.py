...
# Definindo tipos de zumbis e itens especiais
zumbis_types = {
...
itens_especiais = ["pílula de cura", "escudo temporário", "moeda rara"]
...
def evento_aleatorio():
    eventos = [
        "Você encontra um item raro!",
        "Um sobrevivente te oferece ajuda.",
        "Você encontra uma caixa de suprimentos.",
        "Um grupo de zumbis reforça o ataque!"
    ]
...
def salvar_progresso(vida_jogador, zumbis, nivel, inventario, missao_atual, desafios_completos):
    progresso = {
        ...
        "desafios_completos": desafios_completos
    }
...
def jogo():
    ...
    if progresso:
        ...
        if continuar == "sim":
            ...
            desafios_completos = progresso["desafios_completos"]
    ...
    while zumbis["vida"] > 0 and vida_jogador > 0:
        ...
        if acao == "atacar":
            ...
            if fugir():
                ...
                salvar_progresso(vida_jogador, zumbis, nivel, inventario, missao_atual, desafios_completos)
                return
            else:
        ...
        if zumbis["vida"] <= 0:
            ...
            nivel += 1
            zumbis = gerar_zumbis(nivel)
            inventario.append(random.choice(itens_especiais))
            missao_atual = missao(nivel)
            desafios_completos += 1
            print(f"Avançando para o nível {nivel}... Nova missão: {missao_atual}")
            print(f"Você completou {desafios_completos} desafios.")
